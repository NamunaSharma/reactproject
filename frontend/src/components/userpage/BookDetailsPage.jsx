...
//     setCollaborativeFilteringRecommendations,
//   ] = useState([]);
//   // const { id } = useParams();
...
//         `http://localhost:5555/api/reviews/createReview`,
//         reviewData
//       );
...
//           response.data.contentBasedRecommendations
//         );
//         setCollaborativeFilteringRecommendations(
//           response.data.collaborativeFilteringRecommendations
//         );
...
//     setLoading(true);
//     axios
//       .get(`http://localhost:5555/api/reviews/getAllReviews/${bookId}`)
//       .then((response) => {
...
//           <h3 className="text-xl font-bold">Content-Based Recommendations</h3>
//           <ul>
//             {contentBasedRecommendations.map((recommendation) => (
//               <li key={recommendation._id}>
//                 <img
//                   src={`../../src/images/${recommendation.image}`}
...
//           </h3>
//           <ul>
//             {collaborativeFilteringRecommendations.map((recommendation) => (
//               <li key={recommendation._id}>
//                 <img
//                   src={`../../src/images/${recommendation.image}`}
//                   alt={recommendation.title}
...
//       <ul>
//         {contentBasedRecommendations.map((recommendation) => (
//           <li key={recommendation._id}>{recommendation.title}</li>
//         ))}
//       </ul>
...
//           <h3 className="text-xl font-bold">Books based on this one</h3>
//           <div className="flex flex-wrap">
//             {contentBasedRecommendations.map((recommendation) => (
//               <div key={recommendation._id} className="w-1/4 md:w-1/6 p-2 mb-7">
...
//                     {truncateDescription(recommendation.description, 150)}
//                   </p>
//                 </div>
//               </div>
//             ))}
...
//           <div className="flex flex-wrap">
//             {collaborativeFilteringRecommendations.map((recommendation) => (
//               <div key={recommendation._id} className="w-1/4 md:w-1/6 p-2">
