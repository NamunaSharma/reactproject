...
// // // //     try {
// // // //       // Fetch the category ObjectId from the backend
// // // //       const response = await axios.get(
// // // //         `http://localhost:5555/api/category/single-category/${category}`
// // // //       );
...
// // // //       formData.append("category", categoryId); // Use category ObjectId
// // // //       formData.append("image", image);

// // // //       // Send the book creation request with updated data
...
// // //     // Fetch categories
// // //     axios
// // //       .get("http://localhost:5555/api/category/get-category")
// // //       .then((response) => {
...
// // //           />
// // //         </div>
// // //         {/* Repeat similar markup for author, publishYear, and description */}
// // //         <div className="mb-4">
// // //           <label className="block text-gray-700 text-sm font-bold mb-2">
// // //             Author
// // //           </label>
...
//             {/* Replace categories.map() with your logic */}
//             {categories?.map((c) => (
//               <option key={c._id} value={c._id}>
//                 {c.name}
//               </option>
